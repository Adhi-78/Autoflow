...
from app.routers import auth_router, workflow_router, settings_router, google_router
...
app = FastAPI(title="AutoFlow", description="Personal automation platform", version="0.3.0")
